...
<head>
    ...
    <title>{{ __('site.auth_forgot') }} — The Royal Crest</title>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .alert-success{background:rgba(21,66,48,.2);border:1px solid rgba(21,66,48,.5);color:#6ee7b7;border-radius:10px;padding:10px 14px;font-size:.82rem;margin-bottom:1.2rem}
...
<body>
    ...
    <div class="auth-container">
        <div class="form-card">
            ...
            <p class="card-subtitle">{{ __('No problem. Just enter your email address and we will send you a password reset link.') }}</p>
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="f-group">
                    ...
                    <input type="email" name="email" class="f-input" value="{{ old('email') }}" placeholder="your@email.com" required autofocus>
                </div>
