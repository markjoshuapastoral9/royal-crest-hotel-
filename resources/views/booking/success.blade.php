            ...
            <div class="success-card">
                ...
                <div class="details-box">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6"><div class="detail-item"><div class="detail-label">{{ __('site.bs_checkin') }}</div><div class="detail-value">{{ $booking->check_in->format('M d, Y') }}</div></div></div>
                        <div class="col-6"><div class="detail-item"><div class="detail-label">{{ __('site.bs_checkout') }}</div><div class="detail-value">{{ $booking->check_out->format('M d, Y') }}</div></div></div>
