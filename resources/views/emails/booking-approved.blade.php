...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header .checkmark { font-size: 50px; display: block; margin-bottom: 10px; }
    ...
    /* Status badge */
    .status-badge { display: inline-block; background: rgba(76,175,80,.12) !important; color: #4caf50 !important; border: 1px solid rgba(76,175,80,.3); padding: 6px 16px; border-radius: 20px; font-size: 11px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 20px; }
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p class="intro" style="color:#C0C0C0;">Great news! Your booking has been <strong style="color:#4caf50;">confirmed</strong>. We look forward to welcoming you to The Royal Crest.</p>
        ...
        <table class="detail-table">
            ...
            <tr><td style="color:#C0C0C0;">Check-in Date</td><td style="color:#ffffff;">{{ $booking->check_in->format('D, F d, Y') }} · 2:00 PM</td></tr>
            <tr><td style="color:#C0C0C0;">Check-out Date</td><td style="color:#ffffff;">{{ $booking->check_out->format('D, F d, Y') }} · 12:00 PM</td></tr>
        ...
        <p class="intro" style="color:#C0C0C0;">Need to make changes? Contact us at <strong style="color:#A6824A;">info@theroyalcrest.com</strong> or <strong style="color:#A6824A;">+63 75 123 4567</strong> at least 24 hours before your check-in date.</p>
    </div>
