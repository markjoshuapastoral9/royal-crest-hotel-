...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* Info box */
    .info-box { background: rgba(59,130,246,.08) !important; border: 1px solid rgba(59,130,246,.2); border-radius: 12px; padding: 16px 18px; margin: 20px 0; }
    .info-row { font-size: 13px; color: #93c5fd !important; line-height: 1.7; margin: 0; }
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p class="intro" style="color:#C0C0C0;">Your refund has been <strong style="color:#3b82f6;">processed successfully</strong>. The amount will be returned to your original payment method.</p>
        ...
        <table class="detail-table">
            ...
            <tr><td style="color:#C0C0C0;">Refund Amount</td><td style="color:#3b82f6; font-size: 18px; font-family: Georgia, serif; font-weight: bold;">₱{{ number_format($booking->total_amount, 2) }}</td></tr>
        </table>

        {{-- INFO BOX --}}
        <div class="info-box">
            <p class="info-row" style="color:#93c5fd;">⏱ <strong>Please note:</strong> The refund will be processed to your original payment method within 5-10 business days.</p>
        </div>

        <p class="info-text" style="color:#C0C0C0;">If you have any questions about your refund, please contact us with your booking reference number.</p>
    </div>
