...
class PromoSeeder extends Seeder
{
    public function run(): void
    {
        $promos = [
            ...
            // New promos
            ['title' => 'Subo Starter',     'code' => 'SUBO5',    'discount_type' => 'percentage', 'discount_value' => 5,    'minimum_nights' => 1, 'usage_limit' => null, 'valid_until' => now()->addYear()->toDateString(),     'description' => 'Small discount for everyone.'],
